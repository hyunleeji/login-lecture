...
//라우팅
const home = require("./routes/home") //현재폴더(./)에서 /routes/home에서 index.js 파일을 읽게된다. home으로 받아서 루트 경로로오면 home으로 이동하게 되는것.

//앱 세팅
app.set("views", "./views");//화면 뷰를 관리해줄 파일이 저장될 폴더이름을 2번째 파라미터로 연결
